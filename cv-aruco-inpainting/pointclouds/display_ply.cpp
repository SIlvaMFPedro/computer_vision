...
int main(int argc, char **argv)
{
    ...
    if(io::loadPLYFile<PointXYZRGB> ("..//ColouredClouds//foot_bulk_src.ply", *cloud_0) == -1) //* load the file
    {
      PCL_ERROR ("Couldn't read file foot_bulk_src.ply \n");
      return (-1);
    }

    PointCloud<PointXYZRGB>::Ptr cloud_1 (new PointCloud<PointXYZRGB>);
    if (io::loadPLYFile<PointXYZRGB> ("..//ColouredClouds//foot_bulk_test.ply", *cloud_1) == -1) //* load the file
    {
      PCL_ERROR ("Couldn't read file foot_bulk_test.ply \n");
      return (-1);
    }

    // PointCloud<PointXYZRGB>::Ptr cloud_2 (new PointCloud<PointXYZRGB>);
    // if(io::loadPLYFile<PointXYZRGB> ("..//ColouredClouds//foot_bulk_src.ply", *cloud_2) == -1) //* load the file
    // {
    //   PCL_ERROR ("Couldn't read file foot_bulk_src.ply \n");
    //   return (-1);
    // }
    ...
    // if (io::loadPLYFile<PointXYZRGB> ("..//ColouredClouds//foot_bulk_src.ply", *cloud_3) == -1) //* load the file
    // {
    //   PCL_ERROR ("Couldn't read file foot_bulk_src.ply \n");
    //   return (-1);
    // }
    ...
    // if(io::loadPLYFile<PointXYZRGB> ("..//ColouredClouds//foot_bulk_src.ply", *cloud_4) == -1) //* load the file
    // {
    //   PCL_ERROR ("Couldn't read file foot_bulk_src.ply \n");
    //   return (-1);
    // }
    ...
    // if (io::loadPLYFile<PointXYZRGB> ("..//ColouredClouds//foot_bulk_src.ply", *cloud_5) == -1) //* load the file
    // {
    //   PCL_ERROR ("Couldn't read file foot_bulk_src.ply \n");
    //   return (-1);
    // }
    ...
    // if(io::loadPLYFile<PointXYZRGB> ("..//ColouredClouds//foot_bulk_src.ply", *cloud_6) == -1) //* load the file
    // {
    //   PCL_ERROR ("Couldn't read file foot_bulk_src.ply \n");
    //   return (-1);
    // }
    ...
    // if (io::loadPLYFile<PointXYZRGB> ("..//ColouredClouds//foot_bulk_src.ply", *cloud_7) == -1) //* load the file
    // {
    //   PCL_ERROR ("Couldn't read file foot_bulk_src.ply \n");
    //   return (-1);
    // }
    ...
    // if(io::loadPLYFile<PointXYZRGB> ("..//ColouredClouds//foot_bulk_src.ply", *cloud_8) == -1) //* load the file
    // {
    //   PCL_ERROR ("Couldn't read file foot_bulk_src.ply \n");
    //   return (-1);
    // }
    ...
    // if(io::loadPLYFile<PointXYZRGB> ("..//ColouredClouds//foot_bulk_src.ply", *cloud_9) == -1) //* load the file
    // {
    //   PCL_ERROR ("Couldn't read file foot_bulk_src.ply \n");
    //   return (-1);
    // }
    ...
    visualizer.addPointCloud(cloud_0, "Target Cloud");
    visualizer.spin();
