...
int main(int argc, char **argv)
{
    ...
    if(io::loadPLYFile<PointXYZRGB> ("..//ColouredClouds//source//foot_bulk.ply", *cloud_0) == -1) //* load the file
    {
    ...
    if (io::loadPLYFile<PointXYZRGB> ("..//ColouredClouds//source//surface_cloud.ply", *cloud_1) == -1) //* load the file
    {
